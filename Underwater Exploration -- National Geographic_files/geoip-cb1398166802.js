(function(){
    ...
    RENAMES={
        'GB':{
            'Traveler Magazine':'Traveller Magazine'
        }
    }
    ...
    function renameLink($element, country){
        var originalName = $element.text().trim(),
            translatedName;
        if(country in RENAMES){
            translatedName = RENAMES[country][originalName];
            $element.text(translatedName);
        }
