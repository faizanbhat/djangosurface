...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'videos_video', 'description', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Video.description'
        db.alter_column(u'videos_video', 'description', self.gf('django.db.models.fields.CharField')(max_length=200))
